...
CBigNum bnProofOfWorkLimit(~uint256(0) >> 20); // Posex
CBigNum bnProofOfStakeLimit(~uint256(0) >> 20); //  Posex - PoS starting difficulty = 0.0002441
CBigNum bnProofOfWorkLimitTestNet(~uint256(0) >> 16); // Posex - PoW starting difficulty on Testnet

static const int64_t nTargetTimespan = 20 * 60;  // 20 minutes

unsigned int nPowTargetSpacing = 30; // 30 second Pow blocks
...
int nBestHeight = -1;
int nCoinbaseMaturity = 30; // 40 in total count
...
const string strMessageMagic = "Posex Signed Message:\n";
...
unsigned int ComputeMaxBits(CBigNum bnTargetLimit, unsigned int nBase, int64_t nTime)
{
    ...
    {
        // Maximum 200% adjustment per two hours
        bnResult *= 2;
        nTime -= 2 * 60 * 60;
    }
    ...
    const CBlockIndex* pindexBlock, bool fBlock, bool fMiner)
{
    ...
    // fMiner is true when called from the internal posex miner
...
bool CBlock::CheckBlock(bool fCheckPOW, bool fCheckMerkleRoot, bool fCheckSig) const
{
    ...
    if (IsProofOfStake())
    {
        ...
        // Posex: check proof-of-stake block signature
...
// posex: attempt to generate suitable proof-of-stake
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Posex", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (fTestNet)
    {
        ...
        bnTrustedModulus.SetHex("");
        bnProofOfWorkLimit = bnProofOfWorkLimitTestNet; // 16 bits PoW target limit for testnet
        nStakeMinAge = 1; // test net min age is 1 seconds
        nStakeMaxAge = 10 * 60 * 60; // test net max age is 10 hours
        nCoinbaseMaturity = 10; // test maturity is 10 blocks
    }
    else
    {
        bnTrustedModulus.SetHex("");
    }
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "http://www.bbc.co.uk/news/world-us-canada-35413863";
        CTransaction txNew;
        txNew.nTime = 1453830429;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 484668997 << CBigNum(44) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 1000 * COIN;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("04404fa689ad5023690557fbcbc8bcd46c80fa08dce601aaf0b8d3eb4a8e4f3a49c8f13f8db10f447184710c8f470216fe1b51850b4acf21b179c45070ac7b03a9") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1453830429;
        ...
        // debug print
        assert(block.hashMerkleRoot == uint256("0x5ae1e564a136f495da6bd8e1c69775c11abb4b58229a12fdf044456c3453750b"));
        block.print();
