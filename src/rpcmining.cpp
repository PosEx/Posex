...
Value getstakinginfo(const Array& params, bool fHelp)
{
    ...
    int nExpectedTime = staking ? (nStakeTargetSpacingNew * nNetworkWeight / nWeight) : -1;
...
Value getworkex(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(-9, "Posex is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(-10, "Posex is downloading blocks...");
...
Value getwork(const Array& params, bool fHelp)
{
    ...
    if (vNodes.empty())
        throw JSONRPCError(RPC_CLIENT_NOT_CONNECTED, "Posex is not connected!");

    if (IsInitialBlockDownload())
        throw JSONRPCError(RPC_CLIENT_IN_INITIAL_DOWNLOAD, "Posex is downloading blocks...");
...
Value getblocktemplate(const Array& params, bool fHelp)
{
    if (fHelp || params.size() > 1)
        throw runtime_error(
            ...
            "See https://en.posex.it/wiki/BIP_0022 for full specification.");
