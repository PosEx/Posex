...
// for both posexd and posex-qt, to make it harder for attackers to
// target servers or GUI users specifically.
const std::string CLIENT_NAME("Posex");

// Client version number
#define CLIENT_VERSION_SUFFIX   "-Beast"
...
#    define GIT_COMMIT_DATE "Experiment"
#endif
