...
private slots:
    ...
    void on_BuyPEX_clicked();
    void on_SellPEXBTN_clicked();
    void on_SellBidcomboBox_currentIndexChanged(const QString &arg1);
    void on_Sell_Max_Amount_clicked();
    void on_UnitsInputPEX_textChanged(const QString &arg1);
    ...
    QString BuyPEX(QString OrderType, double Quantity, double Rate);
    QString SellPEX(QString OrderType, double Quantity, double Rate);
