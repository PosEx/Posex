...
/**
  Posex GUI main class. This class represents the main window of the Posex UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class PosexGUI : public QMainWindow
{
    Q_OBJECT
public:
    explicit PosexGUI(QWidget *parent = 0);
    ~PosexGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a posex wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
