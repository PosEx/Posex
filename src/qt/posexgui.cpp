...
void PosexGUI::createActions()
{
    ...
    aboutAction = new QAction(QIcon(":/icons/posex"), tr("&About Posex"), this);
    aboutAction->setToolTip(tr("Show information about Posex"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/icons/qtlogo-64"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Posex"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/posex"), tr("&Show / Hide"), this);
...
void PosexGUI::createMenuBar()
{
    ...
    QMenu *wallet = appMenuBar->addMenu(tr("&Account"));
    ...
    QMenu *walletsec = appMenuBar->addMenu(tr("&Wallet Security"));
...
void PosexGUI::setClientModel(ClientModel *clientModel)
{
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/posex_testnet"));
            setWindowIcon(QIcon(":icons/posex_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/posex_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Posex client") + QString(" ") + tr("[testnet]"));
...
void PosexGUI::setWalletModel(WalletModel *walletModel)
{
...
void PosexGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Posex client"));
...
#ifndef Q_OS_MAC
void PosexGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void PosexGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Posex network", "", count));
}

void PosexGUI::setNumBlocks(int count, int nTotalBlocks)
{
...
void PosexGUI::error(const QString &title, const QString &message, bool modal)
{
    // Report errors from network/worker thread
    if(modal)
    {
...
void PosexGUI::changeEvent(QEvent *e)
{
...
void PosexGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void PosexGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage =
        tr("This transaction is over the size limit.  You can still send it for a fee of %1, "
          "which goes to the nodes that process your transaction and helps to support the network.  "
          "Do you want to pay the fee?").arg(
                PosexUnits::formatWithUnit(PosexUnits::PEX, nFeeRequired));
...
void PosexGUI::incomingTransaction(const QModelIndex & parent, int start, int end)
{
        ...
        notificator->notify(Notificator::Information,
                            (amount)<0 ? tr("Sent transaction") :
                              ...
                              tr("Date: %1\n"
                                 ...
                                 "Address: %4\n")
                              .arg(date)
                              .arg(PosexUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                              .arg(type)
                              .arg(address), icon);
    }
}

void PosexGUI::gotoOverviewPage()
{
...
void PosexGUI::gotoStatisticsPage()
{
...
void PosexGUI::gotoBlockBrowser()
{
...
void PosexGUI::gotoAddressBookPage()
{
...
void PosexGUI::gotoReceiveCoinsPage()
{
...
void PosexGUI::gotoSendCoinsPage()
{
...
void PosexGUI::gotoSignMessageTab(QString addr)
{
...
void PosexGUI::gotoVerifyMessageTab(QString addr)
{
...
void PosexGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void PosexGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Posex address or malformed URI parameters."));
    }

    event->acceptProposedAction();
}

void PosexGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void PosexGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void PosexGUI::encryptWallet(bool status)
{
    if(!walletModel)
        return;
...
void PosexGUI::changePassphrase()
{
...
void PosexGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void PosexGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void PosexGUI::updateWeight()
{
    if (!pwalletMain)
        return;
...
void PosexGUI::updateStakingIcon()
{
    updateWeight();
