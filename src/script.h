...
#ifndef H_PEXTION_SCRIPT
#define H_PEXTION_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CPosexAddress
 */
...
public:
    ...
    // Pre-version-0.6, Posex always counted CHECKMULTISIGs
