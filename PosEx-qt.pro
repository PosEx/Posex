...
contains(PEXTION_NEED_QT_PLUGINS, 1) {
    DEFINES += PEXTION_NEED_QT_PLUGINS
...
HEADERS += src/qt/posexgui.h \
    ...
    src/qt/posexaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/posex.cpp src/qt/posexgui.cpp \
    ...
    src/qt/posexaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/posexstrings.cpp \
    src/qt/posexamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/posex.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/posex_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/posex-qt.rc
...
windows:RC_FILE = src/qt/res/posex-qt.rc
...
macx:ICON = src/qt/res/icons/Posex.icns
macx:TARGET = "Posex-Qt"
